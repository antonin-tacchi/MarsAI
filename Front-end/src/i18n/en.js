export default {
  ...
  forgotPassword: {
    ...
    successText: "If this email is associated with an account, you will receive a reset link in a few minutes. Please check your spam folder.",
  },
  ...
  resetPassword: {
    ...
    invalidText: "This reset link is invalid or has expired.",
    newLinkBtn: "Request a new link",
  ...
  changePassword: {
    ...
    titleForce: "Password change required",
    forceNotice: "🔐 First login — you must change your temporary password.",
  ...
  newsletterSubscribe: {
    ...
    submit: "Subscribe",
    loading: "...",
    successMsg: "Confirmation email sent! Check your inbox.",
    hint: "A confirmation email will be sent. No spam, unsubscribe in one click.",
  },

  newsletterConfirm: {
    loading: "Confirming...",
    successTitle: "Subscription confirmed!",
    successText: "You are now subscribed to the MarsAI Festival newsletter. You will receive our latest news.",
    backBtn: "Back to festival",
    errorTitle: "Invalid or expired link",
    errorText: "This confirmation link is invalid or has expired (24h). You can subscribe again to receive a new link.",
  },

  contactNewsletter: {
    title: "Stay informed",
    text: "Subscribe to our newsletter to receive festival news, selection announcements and key dates.",
  },
};