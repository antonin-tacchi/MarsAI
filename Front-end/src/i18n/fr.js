export default {
  ...
  forgotPassword: {
    ...
    successText: "Si cet email est associé à un compte, vous recevrez un lien de réinitialisation dans quelques minutes. Pensez à vérifier vos spams.",
  },
  ...
  resetPassword: {
    ...
    invalidText: "Ce lien de réinitialisation est invalide ou a expiré.",
    newLinkBtn: "Demander un nouveau lien",
  ...
  changePassword: {
    ...
    titleForce: "Changement de mot de passe requis",
    forceNotice: "🔐 Première connexion — vous devez changer votre mot de passe temporaire.",
    ...
    errorMin: "Minimum 8 caractères",
    errorMatch: "Les mots de passe ne correspondent pas",
    errorSame: "Le nouveau mot de passe doit être différent",
    strengthWeak: "Faible",
    strengthMedium: "Moyen",
    strengthStrong: "Fort",
    strengthVeryStrong: "Très fort",
  ...
  newsletterSubscribe: {
    ...
    submit: "S'inscrire",
    loading: "...",
    successMsg: "Email de confirmation envoyé ! Vérifiez votre boîte mail.",
    hint: "Un email de confirmation vous sera envoyé. Pas de spam, désinscription en un clic.",
  },

  newsletterConfirm: {
    loading: "Confirmation en cours...",
    successTitle: "Inscription confirmée !",
    successText: "Vous êtes maintenant inscrit à la newsletter du MarsAI Festival. Vous recevrez nos prochaines actualités.",
    backBtn: "Retour au festival",
    errorTitle: "Lien invalide ou expiré",
    errorText: "Ce lien de confirmation est invalide ou a expiré (24h). Vous pouvez vous réinscrire pour recevoir un nouveau lien.",
  },

  contactNewsletter: {
    title: "Restez informé",
    text: "Inscrivez-vous à notre newsletter pour recevoir les actualités du festival, les annonces de sélection et les dates clés.",
  },
};