  ...
  useEffect(() => {
    const fetchPartners = async () => {
      try {
        ...
        setPartners([
          { id: 1, name: "Partenaire 1", logo: "https://via.placeholder.com/200x80/463699/ffffff?text=Logo+1", url: "https://example.com" },
          { id: 2, name: "Partenaire 2", logo: "https://via.placeholder.com/200x80/8A83DA/ffffff?text=Logo+2", url: "https://example.com" },
          { id: 3, name: "Partenaire 3", logo: "https://via.placeholder.com/200x80/C7C2CE/262335?text=Logo+3", url: "https://example.com" },
          { id: 4, name: "Partenaire 4", logo: "https://via.placeholder.com/200x80/FBD5BD/262335?text=Logo+4", url: "https://example.com" },
          { id: 5, name: "Partenaire 5", logo: "https://via.placeholder.com/200x80/FBF5F0/262335?text=Logo+5", url: "https://example.com" },
          { id: 6, name: "Partenaire 6", logo: "https://via.placeholder.com/200x80/463699/ffffff?text=Logo+6", url: "https://example.com" },
          { id: 7, name: "Partenaire 7", logo: "https://via.placeholder.com/200x80/8A83DA/ffffff?text=Logo+7", url: "https://example.com" },
          { id: 8, name: "Partenaire 8", logo: "https://via.placeholder.com/200x80/C7C2CE/262335?text=Logo+8", url: "https://example.com" },
        ]);
      }
    };
